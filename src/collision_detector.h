...
class ModelItemGathererProvider : public collision_detector::ItemGathererProvider {
public:
    ModelItemGathererProvider(const std::vector<collision_detector::Item>& items,
